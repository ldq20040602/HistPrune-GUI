...
from model_file.LLM_compression_v2_prefusion_action.modeling_qwen2vl import Qwen2VLForConditionalGeneration
# from model_file.LLM_compression_v2_prefusion_summary_instruction.modeling_qwen2vl import Qwen2VLForConditionalGeneration
...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, 
    ...
    if os.path.exists(model_path + '/non_lora_state_dict.bin'):
...
def get_model_name_from_path(model_path):
    ...
    # This code is borrowed from LLaVA
def view_trained_lora(model_path, model_base, model_name, load_8bit=False, load_4bit=False, 
                          device_map="auto", device="cuda", use_flash_attn=False, **kwargs):
    kwargs = {"device_map": device_map}
